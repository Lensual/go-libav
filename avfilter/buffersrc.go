...
func AvBuffersrcWriteFrame(ctx *CAVFilterContext, frame *avutil.CAVFrame) int {
	return int(C.av_buffersrc_write_frame((*C.AVFilterContext)(ctx), (*C.AVFrame)(unsafe.Pointer(frame))))
}
...
func AvBuffersrcAddFrame(buffer_src *CAVFilterContext, frame *avutil.CAVFrame) int {
	return int(C.av_buffersrc_add_frame((*C.AVFilterContext)(buffer_src), (*C.AVFrame)(unsafe.Pointer(frame))))
}
...
func AvBuffersrcAddFrameFlags(buffer_src *CAVFilterContext, frame *avutil.CAVFrame, flags int) int {
	return int(C.av_buffersrc_add_frame_flags((*C.AVFilterContext)(buffer_src), (*C.AVFrame)(unsafe.Pointer(frame)), C.int(flags)))
}
