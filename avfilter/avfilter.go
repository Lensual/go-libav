...
func (filtCtx *CAVFilterContext) GetInputs() **CAVFilterLink {
	return (**CAVFilterLink)(unsafe.Pointer(filtCtx.inputs))
}

// /< number of input pads
func (filtCtx *CAVFilterContext) GetNbInputs() uint {
	return uint(filtCtx.nb_inputs)
}
...
func (filtCtx *CAVFilterContext) GetOutputs() **CAVFilterLink {
	return (**CAVFilterLink)(unsafe.Pointer(filtCtx.outputs))
}

// /< number of output pads
func (filtCtx *CAVFilterContext) GetNbOutputs() uint {
	return uint(filtCtx.nb_outputs)
}
...
func (l *CAVFilterLink) GetTimeBase() avutil.CAVRational {
	return *(*avutil.CAVRational)(unsafe.Pointer(&l.time_base))
}
...
func AvfilterGetByName(name string) *CAVFilter {
	...
	return (*CAVFilter)(C.avfilter_get_by_name(cName))
}
...
func AvfilterGraphAlloc() *CAVFilterGraph {
	return (*CAVFilterGraph)(C.avfilter_graph_alloc())
}
...
func AvfilterGraphCreateFilter(filt_ctx **CAVFilterContext, filt *CAVFilter,
	...
	return int(C.avfilter_graph_create_filter((**C.AVFilterContext)(unsafe.Pointer(filt_ctx)), (*C.AVFilter)(filt), cName, cArgs, opaque, (*C.AVFilterGraph)(graph_ctx)))
}
...
func AvfilterGraphConfig(graphctx *CAVFilterGraph, log_ctx unsafe.Pointer) int {
	return int(C.avfilter_graph_config((*C.AVFilterGraph)(graphctx), log_ctx))
}
...
// #region CAVFilterInOut

/** unique name for this input/output in the list */
func (inout *CAVFilterInOut) GetName() string {
	return C.GoString(inout.name)
}
...
func AvfilterInoutAlloc() *CAVFilterInOut {
	return (*CAVFilterInOut)(C.avfilter_inout_alloc())
}
